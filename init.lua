...
-- Map Ctrl+D to move down by half a screen and center the cursor.
vim.keymap.set('n', '<C-d>', '<C-d>zz', { noremap = true })

-- Map Ctrl+U to move up by half a screen and center the cursor.
...
require('lazy').setup({
  ...
  -- ynml ybnqvat cyhtvaf gung qba'g arrq gb or ybnqrq vzzrqvngryl ng fgneghc.
  --
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      vim.cmd.colorscheme 'catppuccin-macchicato'
    end,
  },
